...
Ncpus = 16
UserRoutine=ModelCase+'_user_subs.f'
...
mdb.models[NameModel].fieldOutputRequests['F-Output-2'].setValues(frequency=freq)
...
### Save Field output
session.writeFieldReport(fileName=NameModel+'_S_local.out', append=OFF, 
    ...
    COMPONENT, 'S11'), (COMPONENT, 'S22'), (COMPONENT, 'S12'), (COMPONENT, 'S13'), )), ), 
    stepFrame=SPECIFY)
    
session.writeFieldReport(fileName=NameModel+'_E_local.out', append=OFF, 
    sortItem='Element Label', odb=odbObj, step=0, frame=vps.odbDisplay.fieldFrame[-1], 
    outputPosition=INTEGRATION_POINT, variable=(('E', INTEGRATION_POINT, ((
    COMPONENT, 'E11'), (COMPONENT, 'E22'), (COMPONENT, 'E12'), (COMPONENT, 'E13'),
...
session.writeFieldReport(fileName=NameModel+'_S_global.out', append=OFF, 
    sortItem='Element Label', odb=odbObj, step=0, frame=vps.odbDisplay.fieldFrame[-1], 
    outputPosition=INTEGRATION_POINT, variable=(('S', INTEGRATION_POINT, ((
    COMPONENT, 'S11'), (COMPONENT, 'S22'), (COMPONENT, 'S12'), (COMPONENT, 'S13'), )), ), 
    stepFrame=SPECIFY)
